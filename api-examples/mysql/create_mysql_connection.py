...
from base_classes.zoomdata_api_mysql import MySQLConnection
...
jdbc_url = raw_input("Enter the JDBC connection string for your MySQL instance (i.e. jdbc:hive2://<server>:<port>/;auth=noSasl): ")
...
connection = MySQLConnection(connectionName, zoomdataServerRequest, jdbc_url, connectionUser, connectionPassword, connectionTypeID)
