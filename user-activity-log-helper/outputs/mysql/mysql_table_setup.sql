...
CREATE INDEX idx_account_event_date 
    USING BTREE USING BTREE ON account_logs 
    (event_date DESC);

CREATE INDEX idx_account_event_date
    USING BTREE ON account_logs 
    (event_date DESC);
...
CREATE INDEX idx_authentication_event_date
    USING BTREE ON authentication_logs 
    (event_date DESC);
...
CREATE INDEX idx_raw_data_event_date
    USING BTREE ON raw_data_export_logs 
    (event_date DESC);
...
CREATE INDEX idx_raw_data_csv_event_date
    USING BTREE ON raw_data_export_csv_logs 
    (event_date DESC);
...
CREATE INDEX idx_security_key_event_date
    USING BTREE ON security_key_logs 
    (event_date DESC);
...
CREATE INDEX idx_oauth_client_event_date
    USING BTREE ON oauth_client_logs 
    (event_date DESC);
...
CREATE INDEX idx_oauth_token_event_date
    USING BTREE ON oauth_token_logs 
    (event_date DESC);
...
CREATE INDEX idx_topology_perf_event_date
    USING BTREE ON topology_performance_logs 
    (event_date DESC);
